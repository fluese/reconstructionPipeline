...
settings.options.output.shortName               = false;             % Instead of using parameters in folder and filenames, use shortest possible unambigous name.
settings.options.output.shortFilename           = false;              % Use short name for NIfTI
