...
%% HISTORY
%%
%% 01 May 2019 (Falk Luesebrink, Otto-von-Guericke University, Magdeburg, Germany)
%% o Correction factor is now based on image resolution and not fixed (from -0.67)
%% o Other minor changes to the initializatio of M_V.
%% 26 May 2004
